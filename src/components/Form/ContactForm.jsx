...
const ContactForm = ({ theme }) => {
  ...
  const validate = () => {
    ...
    if (!formData.requirements) errors.requirements = "Please select your preferred course or stream."; // Updated validation for requirements
    return errors;
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      const mailtoLink = `mailto:info@arthatutorials.com?subject=Enrollment Inquiry&body=Name: ${formData.name}%0D%0AEmail: ${formData.email}%0D%0APhone: ${formData.phone}%0D%0ACourse Inquiry: ${formData.requirements}`;
  ...
  <div className="container min-h-[100vh] flex items-center justify-center sm:mt-0 font-lato">
    ...
    >
      <h2 className="text-2xl font-semibold text-center mb-6">
        Enroll with Artha Tutorials <br />
        Start your PUC Success Journey
      </h2>
