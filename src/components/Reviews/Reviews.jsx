...
const testimonialData = [
  {
    ...
    text: "Artha Academy has been more than just a tuition — they have guided us in times of need, built our confidence, and been tremendously supportive alongside preparing us to ace our exams. I have never felt stressed at all and have been able to do my best in my exams as well as University personal interviews. Thanks to Artha I have been able to secure the 10th rank for the state. Thank you, Artha for giving me another place to call 'home'.",
  },
  {
    id: 2,
    name: "Savitha Ramu — Parent of Greeshma Ramu (96.17%), State 21st Rank",
    text: "A big applause and thank you to Rajesh sir, Akshay sir, and all the other teachers for their hard work and passion. With all of your constant support and guidance, my ward Greeshma Ramu has scored a distinction in the exam. I feel that my decision was right in sending my ward to Artha Academy. I wish for great success to Artha. Keep it up.",
  },
  {
    id: 3,
    name: "Namana (97.50%) — Crash Course Student",
    text: "Artha Academy is not your average commerce coaching center. The moment you step inside, you're greeted by educators who are genuinely invested in your academic growth. Here, I found the best teachers whom I can call my best friends. They create a space where students feel empowered to explore and learn and also ensure that each one of them feels valued and understood. In short, Artha is a home away from home :)",
  },
  {
    id: 4,
    name: "Vibha Gangamma (96%) — National Level Hockey Team",
    text: "I could never imagine Academy being more fun, creative, and inclusive. Artha's teachers focus on connecting with each individual and bringing out their shine, which distinguishes them from normal Academy. They provide not only academic support but also guarantee fun-filled learning outside the world of books.",
  },
  {
    id: 5,
    name: "Purnima Raghu — Parent of Monitha (92.33%)",
    text: "I'm very happy to send my daughter to Artha Academy. The teachers are excellent and will pay individual attention to students and have a great atmosphere. I recommend Artha Academy to students who want to join and excel in their studies. The teachers are very understanding and very reliable. Overall I'm happy with my daughter's performance.",
  },
  {
    id: 6,
    name: "Vanitha Sukesh — Parent of Smrithi (95%), Teacher at Good Shepherd",
    text: "I thank you for your dedication to helping your students learn and grow. Your passion for teaching is truly inspiring. Your encouragement and support have helped my child build confidence in her abilities. I would highly recommend Artha Academy for coaching.",
  },
  {
    id: 7,
